...
class HUD:
    ...
    def _update_hi_score(self):
        hi_score_string = f'Hi-Score: {self.game_stats.hi_score: ,.0f}'
        self.hi_score_image = self.font.render(hi_score_string, True, self.settings.text_color, None)
    ...
    def _update_max_score(self):
        ...
        self.max_score_image = self.font.render(max_score_string, True, self.settings.text_color, None)
    ...
    def _update_score(self):
        ...
        self.score_image = self.font.render(score_string, True, self.settings.text_color, None)
    ...
    def update_level(self):
        ...
        self.level_image = self.font.render(level_string, True, self.settings.text_color, None)
